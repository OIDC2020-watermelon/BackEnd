...
public class ProductService {
    ...
    public List<ResProductForListDto> searchProducts(String keyword, Category category, Pageable pageable) {
        ...
        return products.stream()
                .map(p -> modelMapper.map(p, ResProductForListDto.class))
                .collect(Collectors.toList());
    }

    public List<ResProductForListDto> getProducts() {
